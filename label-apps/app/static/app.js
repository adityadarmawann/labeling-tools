...
/*
 * Chip kelas di kartu grid tidak lagi butuh JS.
 *
 * Sebelumnya katupLabel() mengukur lebar tiap jalur lalu menyembunyikan chip
 * yang tidak muat. Hasilnya benar, tetapi jumlah nama yang tampil jadi
 * berbeda-beda antar kartu di baris yang sama, dan deretnya terbaca tidak
 * rapi. Aturannya sekarang TETAP: dua nama, satu per baris, sisanya dihitung
 * di pil "+N" oleh template. Tidak ada yang perlu diukur saat berjalan, jadi
 * tidak ada pula yang perlu dihitung ulang saat jendela diubah ukuran.
 */
